...
@section('title', 'FavRes | Register')

@section('content')
    <div class="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center overflow-hidden">
        <div class="bg-gray-100 text-gray-500 w-full">
            <div class="md:flex w-full">
                ...
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <div class="text-center mb-10">
                        ...
                        <p>Masukkan informasi akun Anda untuk Register</p>
                    </div>
                    <form method="POST" action="/register">
                        @csrf
                        <div class="flex -mx-3">
                            <div class="w-3/5 px-3 mb-2">
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-2">
                                <label for="" class="text-xs font-semibold px-1">Confirmm password</label>
                                <div class="flex">
                                    <div
                                        class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                        <i class="mdi mdi-lock-outline text-gray-400 text-lg"></i>
                        ...
                        <p class="mb-6">Sudah punya akun? <a href="/login" class="text-indigo-600 hover:underline">Login</a></p>
                        <div class="flex -mx-3">
