            ...
            <div class="md:flex w-full">
                ...
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <div class="text-center mb-10">
                        ...
                        <p>Masukkan informasi akun Anda untuk Login</p>
                    </div>
                    <form method="POST" action="/login">
                        ...
                        {{-- Remember me --}}
                        <div class="flex mb-4">
                            <input type="checkbox" name="remember" id="remember" class="mr-2" {{ $remember ? 'checked' : '' }}>
                            <label for="remember">Remember me</label>
                        </div>
                        <p class="mb-6">Belum punya akun? <a href="/register"
