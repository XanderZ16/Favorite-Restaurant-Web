...
@section('title', 'FavRes | Edit Account')
            ...
            <div class="md:flex w-full">
                ...
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <div class="text-center mb-10">
                        <h1 class="font-bold text-3xl text-gray-900">Ganti data</h1>
                        <p>Ganti data akun Anda</p>
                    </div>
                    <form method="POST" action="/user/{{ $name }}">
                        ...
                        <a href="/change-password" class="inline-block text-indigo-600 hover:underline mb-4">Ganti password?</a>
                        <div class="flex -mx-3">
